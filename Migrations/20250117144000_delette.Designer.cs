...
namespace MYGUYY.Migrations
{
    ...
    [Migration("20250117144000_delette")]
    partial class delette
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MYGUYY.Models.Message", b =>
                {
                    ...
                    b.HasOne("MYGUYY.Models.TaskRequest", null)
                        .WithMany("Messages")
                        .HasForeignKey("TaskRequestId1");
